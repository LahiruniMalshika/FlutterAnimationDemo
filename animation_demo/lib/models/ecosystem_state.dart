...
class ZoneState {
  final String physicalForest;
  final String vitalityGarden;
  final String moonlitMeadow;
  final String serenitySpring;
  final String dock;
...
class BonsaiInfo {
  ...
  const BonsaiInfo({
    required this.state,
    required this.meditationPointsLast7Days,
  });
...
class EcosystemState {
  ...
  factory EcosystemState.initial() => EcosystemState(
        ...
        bonsai: const BonsaiInfo(
          state: BonsaiState.none,
          meditationPointsLast7Days: 0,
        ),
      );
  ...
  factory EcosystemState.fromJson(Map<String, dynamic> json) {
    ...
    return EcosystemState(
      ...
      wildlife: WildlifeState.fromJson(
        json['wildlife'] as Map<String, dynamic>,
      ),
